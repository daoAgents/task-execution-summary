...
- references/v3-planning/v3-user-research-spec.md：用户研究方案（与报告生成的用户需求对齐）
...
- [v3-user-research-spec.md:1-800](file://references/v3-planning/v3-user-research-spec.md#L1-L800)