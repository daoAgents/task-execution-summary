...
| 值 | 预计篇幅 | 包含内容 | 适用场景 |
|---|---------|---------|---------|
| `summary` | 2-3页（500-800字） | 核心章节（第一章完整 + 第十章摘要） | 快速汇报、周报 |
| `standard` | 8-15页（3000-5000字） | 完整十章结构 | 常规复盘、知识分享 |
| `detailed` | 20-30页（8000-15000字） | 所有十章深入 + 完整附录 | 深度复盘、审计 |
...
**约束**: 必须包含第一章、第九章、第十章中的至少一个；不能排除第一章、第九章、第十章的全部。
