...
| 步骤 | 名称 | 核心功能 | 关键输出 |
|------|------|----------|----------|
| 1 | 参数解析验证 | 校验输入参数完整性和有效性 | 验证通过的参数集 |
| 2 | 触发模式识别 | 判断触发模式，确定收集范围 | 时间窗口和任务边界 |
| 3 | 信息收集 | 从对话历史提取6类核心信息 | 结构化任务数据 |
| 4 | 多维分析 | 五维深度分析 | 分析评估结果 |
| 5 | 报告生成 | 基于10章模板动态填充 | 结构化报告草稿 |
| 6 | 智能推荐 | 方法论提炼+改进建议 | 可操作行动指导 |
| 7 | 质量输出 | 完整性/准确性/语言质量检查 | 最终Markdown报告 |

> 各步骤的详细说明、输入输出规范、错误处理见 [execution-flow.md](references/execution-flow.md)，速查版见 [execution-flow-quick.md](references/execution-flow-quick.md)
