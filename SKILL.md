...
| 文档 | 版本 | 说明 |
|------|------|------|
| SKILL.md | v2.3 | 主文档，用户指南 |
| api-reference.md | v1.0 | 完整 API 详解 |
| error-codes.md | v1.0 | 完整错误码详解 |
| execution-flow.md | v1.0 | 完整执行流程 |
| templates.md | v1.0 | 完整模板详解 |
| examples-v2.md | v2.0 | 完整使用示例 |
| terminology.md | v1.0 | 术语表 |
| api-reference-quick.md | v1.0 | API 端点速查 |
| error-codes-quick.md | v1.0 | 错误码速查表 |
| execution-flow-quick.md | v1.0 | 执行流程速览 |
| templates-quick.md | v1.0 | 模板结构速查 |
...
|---------|-------------|-----------|
| 日常使用 | SKILL.md + 4个quick文件 | ~6,100 |
| 深度集成 | 日常 + P1层完整文档 | ~22,400 |
| 全量参考 | 深度 + terminology.md | ~26,100 |
...
**Q8: 是否支持多语言输出？**
A: 当前版本（v2.x）主要支持中文输出，对中英混合输入有良好的处理能力。完整的多语言支持已列入 V3 路线图规划。

**Q9: 如何自定义报告模板？**
A: 当前提供四种模板变体（summary/standard/detailed/learning），可通过 `detail_level` 和 `template_variant` 参数选择。完全自定义功能已列入 V3 路线图。

**Q10: 生成的报告可以导出到外部工具吗？**
A: 当前输出 Markdown 格式，可手动导入 Confluence、Notion、飞书等平台。自动化集成已列入 V3 路线图。
